...
ADS131M08::ADS131M08() : csPin(0), drdyPin(0), clkPin(0), misoPin(0), mosiPin(0)
{
...
uint16_t ADS131M08::SendCommand(uint8_t command)
{
  uint16_t data;
...
void ADS131M08::begin(uint8_t clk_pin, uint8_t miso_pin, uint8_t mosi_pin, uint8_t cs_pin, uint8_t drdy_pin)
{
  // Set pins up
  csPin = cs_pin;
  drdyPin = drdy_pin;
